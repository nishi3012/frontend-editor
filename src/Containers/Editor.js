...
// Use environment variables from Netlify build
const serverURL = process.env.REACT_APP_SERVER_URL; // e.g., "https://backend-f57ybo300-kadamnishita12-8917s-projects.vercel.app"
const websocketURL = process.env.REACT_APP_WEB_SOCKET_URL; // e.g., "wss://backend-f57ybo300-kadamnishita12-8917s-projects.vercel.app"
